    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // If no session or no redirect, show the home page content
            ...
            <AnimatePresence>
                {isCheckingSession && (
                    <motion.div
                        initial={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-loops-bg"
                    >
                        <motion.div
                        ...
                        >
                            <div className="relative">
                                <motion.div
                                    ...
                                    className="absolute inset-0 bg-loops-primary/20 blur-3xl rounded-full"
                                />
                                <div className="relative w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-[2rem] border border-loops-border flex items-center justify-center shadow-2xl shadow-loops-primary/10 overflow-hidden transform rotate-3">
                                    <InfinityLogo className="w-16 h-16 sm:w-20 sm:h-20" />
                                </div>
                            </div>
                            ...
                            <div className="text-center space-y-2">
                                <motion.p
                                    ...
                                    className="text-[10px] font-bold text-loops-primary uppercase tracking-[0.3em]"
                                >
                                    Authenticating
                                </motion.p>
                                <motion.h2
                                    ...
                                    className="font-display text-4xl sm:text-5xl font-bold tracking-tighter italic text-loops-main"
                                >
                                    Loops.
                                </motion.h2>
                            </div>
                            ...
                            <motion.div
                                ...
                                className="h-0.5 bg-loops-primary/10 rounded-full overflow-hidden"
                            >
                                <motion.div
                                    animate={{ x: [-100, 100] }}
                                    transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                                    className="h-full w-1/2 bg-loops-primary"
                                />
                            </motion.div>
                        </motion.div>
                    </motion.div>
