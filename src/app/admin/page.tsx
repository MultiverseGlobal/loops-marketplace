            ...
            <div className="space-y-8">
                ...
                {userTab === 'requests' ? (
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        {/* Directory List */}
                        <div className="bg-white border border-loops-border rounded-[2.5rem] overflow-hidden shadow-sm">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-loops-subtle/50 border-b border-loops-border">
                                        ...
                                        <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-loops-muted">Joined</th>
                                ...
                                <tbody className="divide-y divide-loops-border">
                                    {filteredUsers.map(user => (
                                        <tr key={user.id} className="hover:bg-loops-subtle/30 transition-colors group">
